---Found a bug in nn.MixtureTable. Got it fixed.

local MixtureTable, parent = torch.class('nn.myMixtureTable', 'nn.Module')
...
--  print('Start debug Mixture table ------------------------------------')
...
--    print('self.batchSize is ') print(self.batchSize)
--    print(' batchSize is ') print(batchSize)
...
--    print('self.size is')
--    print(self.size)
--    print('gaterInput size is ') print(gaterInput:size())
    self._gaterView:view(gaterInput, self.size)   --- This is the fix. @Wei Zhang
